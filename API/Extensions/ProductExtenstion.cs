...
namespace API.Extensions
{
    public static  class ProductExtenstion
    {
        ...
        public static IQueryable<Product> Filter(this IQueryable<Product> query, string brands, string types)
        {
            ...
            query = query.Where(p => brandList.Count == 0 || brandList.Contains(p.Category.Brand.ToLower()));
            query = query.Where(p => typeList.Count == 0 || typeList.Contains(p.Category.Type.ToLower()));
